...
public class SQLiteAssetHelper extends SQLiteOpenHelper {
    ...
    public String getmDatabasePath() {
	...
	private void setForeignKeyConstraintsEnabled(SQLiteDatabase db,boolean enabled) {
	...
	/**
	 * Remove any open database object.
	 */
	public synchronized void remove() {

		File f=new File(mDatabasePath + "/" + mName);
		close();
		f.delete();
	}
	...
	private SQLiteDatabase returnDatabase(){
		try {
			...
			dataBasePath=mDatabasePath + "/" + mName;
			dataBaseFile=new File(dataBasePath);

			if (false==dataBaseFile.exists())
				return null;

			SQLiteDatabase db = SQLiteDatabase.openDatabase(dataBasePath, mFactory, SQLiteDatabase.OPEN_READWRITE);
